...
@DebugMetadata(m719c = "com.lladlam.melox.ui.library.LibraryScreenKt$MeloXPlaylistDetailScreen$4$1$2$1$3$1$1$1$1", m720f = "LibraryScreen.kt", m721i = {}, m722l = {766}, m723m = "invokeSuspend", m724n = {}, m725nl = {767}, m726s = {}, m727v = 2)
final class LibraryScreenKt$MeloXPlaylistDetailScreen$4$1$2$1$3$1$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    LibraryScreenKt$MeloXPlaylistDetailScreen$4$1$2$1$3$1$1$1$1(MutableState<Boolean> mutableState, MutableState<String> mutableState2, NeteaseLibraryClient neteaseLibraryClient, NeteasePlaylistSummary neteasePlaylistSummary, NeteaseLibraryCache neteaseLibraryCache, MutableState<NeteasePlaylistDetail> mutableState3, Continuation<? super LibraryScreenKt$MeloXPlaylistDetailScreen$4$1$2$1$3$1$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new LibraryScreenKt$MeloXPlaylistDetailScreen$4$1$2$1$3$1$1$1$1(this.$loading$delegate, this.$errorMessage$delegate, this.$client, this.$initialPlaylist, this.$cache, this.$detail$delegate, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((LibraryScreenKt$MeloXPlaylistDetailScreen$4$1$2$1$3$1$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
