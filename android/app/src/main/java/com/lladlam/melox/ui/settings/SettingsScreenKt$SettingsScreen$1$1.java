...
final class SettingsScreenKt$SettingsScreen$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    SettingsScreenKt$SettingsScreen$1$1(NeteaseSessionStore neteaseSessionStore, Continuation<? super SettingsScreenKt$SettingsScreen$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SettingsScreenKt$SettingsScreen$1$1(this.$session, continuation);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (this.$session.isLoggedIn()) {
                    this.label = 1;
                    if (NeteaseSessionStore.refreshProfile$default(this.$session, false, this, 1, null) == coroutine_suspended) {
