...
@DebugMetadata(m719c = "com.lladlam.melox.ui.discovery.MeloXDiscoveryScreensKt$HomeBrowser$2$1$1", m720f = "MeloXDiscoveryScreens.kt", m721i = {}, m722l = {291}, m723m = "invokeSuspend", m724n = {}, m725nl = {-1}, m726s = {}, m727v = 2)
final class MeloXDiscoveryScreensKt$HomeBrowser$2$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    MeloXDiscoveryScreensKt$HomeBrowser$2$1$1(MutableState<Boolean> mutableState, MutableState<String> mutableState2, NeteaseLibraryClient neteaseLibraryClient, NeteaseDiscoveryCache neteaseDiscoveryCache, MutableState<NeteaseHomeSnapshot> mutableState3, Continuation<? super MeloXDiscoveryScreensKt$HomeBrowser$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MeloXDiscoveryScreensKt$HomeBrowser$2$1$1(this.$loading$delegate, this.$errorMessage$delegate, this.$client, this.$cache, this.$snapshot$delegate, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MeloXDiscoveryScreensKt$HomeBrowser$2$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
