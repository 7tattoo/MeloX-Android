...
@DebugMetadata(m719c = "com.lladlam.melox.ui.discovery.MeloXDiscoveryScreensKt$ExploreBrowser$2$1$1", m720f = "MeloXDiscoveryScreens.kt", m721i = {}, m722l = {180}, m723m = "invokeSuspend", m724n = {}, m725nl = {-1}, m726s = {}, m727v = 2)
final class MeloXDiscoveryScreensKt$ExploreBrowser$2$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    MeloXDiscoveryScreensKt$ExploreBrowser$2$1$1(SnapshotStateMap<String, List<NeteasePlaylistSummary>> snapshotStateMap, MutableState<String> mutableState, MutableState<List<NeteasePlaylistSummary>> mutableState2, MutableState<Boolean> mutableState3, MutableState<String> mutableState4, NeteaseLibraryClient neteaseLibraryClient, NeteaseDiscoveryCache neteaseDiscoveryCache, Continuation<? super MeloXDiscoveryScreensKt$ExploreBrowser$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MeloXDiscoveryScreensKt$ExploreBrowser$2$1$1(this.$memoryCache, this.$category$delegate, this.$playlists$delegate, this.$loading$delegate, this.$errorMessage$delegate, this.$client, this.$cache, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MeloXDiscoveryScreensKt$ExploreBrowser$2$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
