...
final class MeloXIOSLyricsPanelKt$MeloXIOSLyricsPanel$3$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    MeloXIOSLyricsPanelKt$MeloXIOSLyricsPanel$3$1(String str, MutableState<Boolean> mutableState, MutableState<String> mutableState2, NeteaseSearchClient neteaseSearchClient, MutableState<LyricsDocument> mutableState3, Continuation<? super MeloXIOSLyricsPanelKt$MeloXIOSLyricsPanel$3$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        MeloXIOSLyricsPanelKt$MeloXIOSLyricsPanel$3$1 meloXIOSLyricsPanelKt$MeloXIOSLyricsPanel$3$1 = new MeloXIOSLyricsPanelKt$MeloXIOSLyricsPanel$3$1(this.$mediaId, this.$isLoading$delegate, this.$errorMessage$delegate, this.$client, this.$lyrics$delegate, continuation);
        meloXIOSLyricsPanelKt$MeloXIOSLyricsPanel$3$1.L$0 = obj;
        return meloXIOSLyricsPanelKt$MeloXIOSLyricsPanel$3$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MeloXIOSLyricsPanelKt$MeloXIOSLyricsPanel$3$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        try {
            switch (this.label) {
                case 0:
                    ...
                    MeloXIOSLyricsPanelKt.MeloXIOSLyricsPanel$lambda$6(this.$isLoading$delegate, true);
            ...
            objM9714constructorimpl = Result.constructor_impl((LyricsDocument) objLyrics);
        } catch (Throwable th) {
        ...
        MeloXIOSLyricsPanelKt.MeloXIOSLyricsPanel$lambda$6(this.$isLoading$delegate, false);
        return Unit.INSTANCE;
    }
}
